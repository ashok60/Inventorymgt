...
public class InventoryUi {
	...
	public void run() {
		try {
			...
			Phone phone1 = new Phone("Oneplus", supplier1, 10000);
			phone1 = phoneService.save(phone1);
			Phone phone2 = new Phone("Samsung", supplier2, 5000);
			phone1 = phoneService.save(phone2);

			System.out.println("*****Sprint 3 completed******");

			Computer comp1 = new Computer("HP", supplier1, 7000);
			comp1 = compService.save(comp1);
			Computer comp2 = new Computer("Lenovo", supplier2, 8000);
