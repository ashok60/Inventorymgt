...
public class PhoneController extends Item{
	...
	public void init() {
		...
		Supplier supplier1 = new Supplier("jithin", "micky");
		supplier1 = supplierService.save(supplier1);

		Supplier supplier2 = new Supplier("girish", "vijay");
		supplier2 = supplierService.save(supplier2);


		Phone phone1 = new Phone("oneplus", 1000);
		phone1 = phoneService.save(phone1);
		Phone phone2 = new Phone("samsung", 2000);
